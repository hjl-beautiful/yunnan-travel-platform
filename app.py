...
with st.sidebar:
    ...
    <div style="text-align: center; margin-bottom: 24px;">
        ...
        <div style="font-size: 11px; color: #94a3b8; margin-top: 4px;">v2.1 | 九寨沟数据验证</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    # 数据源选择
    st.markdown("<div style='font-size: 12px; color: #e2e8f0; margin-bottom: 8px; font-weight: 600;'>数据源配置</div>", unsafe_allow_html=True)
    ...
    # 预测参数
    st.markdown("<div style='font-size: 12px; color: #e2e8f0; margin-bottom: 8px; font-weight: 600;'>预测参数</div>", unsafe_allow_html=True)
    ...
    # 导出
    st.markdown("<div style='font-size: 12px; color: #e2e8f0; margin-bottom: 8px; font-weight: 600;'>数据导出</div>", unsafe_allow_html=True)
    ...
    with st.container(border=True):
        ...
        if not display_df.empty:
            ...
            fig.update_layout(
                ...
                yaxis=dict(showgrid=True, gridcolor="rgba(100,180,255,0.06)", title="日均客流", title_font_color="#94a3b8"),
                showlegend=False,
            )
